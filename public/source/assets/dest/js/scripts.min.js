!function(a){a.fn.betaSelect=function(b){
	var c={text:"",value:"","class":""},d=a.extend({},c,b);
...
jQuery("input[name='payment_method']").on("click",function(){
	var a=jQuery(this).attr("id");jQuery(".payment_box").each(function(b,c){
...
var c=window.matchMedia("(max-width: 1200px)");c.matches&&jQuery(".beta-banner .beta-fallback").each(function(a,b){
